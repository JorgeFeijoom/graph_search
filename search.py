...
#Busca los nodos mas superficiales primero
def breadth_first_graph_search(problem):
    """Search the shallowest nodes in the search tree first. [p 74]"""
    return graph_search(problem, FIFOQueue())  # FIFOQueue -> fringe


#Busca los nodos mas profundos primero
...
#Ramficiacion y salto
def ramSalto_graph_search(problem):
    return tree_search(problem, RamificacionSalto())

#Ramficiacion y salto con Heuristica
def ramSalto_H_graph_search(problem):
    return tree_search(problem, RamificacionSaltoH(problem))
